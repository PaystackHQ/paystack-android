...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (BuildConfig.DEBUG && (BuildConfig.PAYSTACK_PUBLIC_KEY.equals(""))) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_mobile_money) {
            Intent i = new Intent(this, MobileMoneyActivity.class);
            startActivity(i);
            return true;
        }
